...
<html class="wide wow-animation" lang="en">
  <head>
    <title translate="no">JurisNova</title>
  ...
  <body>
    ...
    <div class="page">
                ...
                <div class="container">
                  <div class="row justify-content-md-center">
                    <div class="col-md-11 col-lg-10 col-xl-9">
                      ...
                      <div class="button-block" data-caption-animate="fadeInUp" data-caption-delay="400"><a class="button button-lg button-primary-outline-v2" href="#contact">Request a Free Consultation</a></div>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section class="bg-displaced-wrap" id="about">
                ...
                <div class="box-cart-body">
                  <blockquote class="blockquote-complex blockquote-complex-inverse">
                    ...
                    <div class="quote-footer">
                      <cite>Anne-Maria BURNN</cite><small>CEO at JurisNova</small>
                    </div>
                  </blockquote>
                  <div class="button-wrap inset-md-left-70"><a class="button button-responsive button-medium button-primary-outline-v2" href="#contact">Request a Free Consultation</a></div>
                </div>
              </article>
            </div>
          </div>
        </div>
        <div class="bg-displaced bg-image" style="background-image: url(https://livedemo00.template-help.com/free_2013_responsive_template/images/home-1.jpg);"></div>
      </section>
              ...
              <div class="thumbnail-variant-2-wrap">
                <div class="thumbnail thumbnail-variant-2">
                  ...
                  <div class="thumbnail-caption">
                    <p class="text-header"><a href="#">Amanda Tanrow</a></p>
            ...
            <div class="col-sm-6 col-md-4 col-lg-3">
              <div class="thumbnail-variant-2-wrap">
                <div class="thumbnail thumbnail-variant-2">
                  ...
                  <div class="thumbnail-caption">
                    <p class="text-header"><a href="#">John Tamahow</a></p>
                    <div class="divider divider-md bg-teak"></div>
            ...
            <div class="item">
              <blockquote class="quote-bordered">
                <div class="quote-body">
                  ...
                  <div class="quote-body-inner">
                    <h6>JurisNova is One of The Best...</h6>
                    <p>
                      <q>Anne-Marie Burnn is one of those attorneys who has it all-talent and skill, compassion for his clients, and the ability to communicate well with anyone he meets. This is one of the best combinations for a trial attorney and he is one of the best.</q>
                    </p>
                  </div>
                </div>
                <div class="quote-footer">
      ...
      <section class="bg-whisper" id="contact">
        <div class="container">
          <div class="row">
